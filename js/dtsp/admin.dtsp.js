...
$(document).ready(function(){
	...
	$("#admin-game-restart").click(function(){
		$.post('ajax.dtsp.php', {action : 'admin', admin_action : 'game_restart'}, function(data, status){
			if(data['success']){
				alert("游戏已重新开始!");
			}else{
				alert("操作失败");
	...
	$("#admin-game-start").click(function(){
		$.post('ajax.dtsp.php', {action : 'admin', admin_action : 'game_start'}, function(data, status){
			if(data['success']){
				alert("游戏已开始");
			}else{
				alert("操作失败");
	...
	$("#admin-game-forbid").click(function(){
		$.post('ajax.dtsp.php', {action : 'admin', admin_action : 'game_forbid'}, function(data, status){
			if(data['success']){
				alert("已进入下一次禁区");
			}else{
				alert("操作失败");
	...
	$("#admin-game-stop").click(function(){
		$.post('ajax.dtsp.php', {action : 'admin', admin_action : 'game_end'}, function(data, status){
			if(data['success']){
				alert("游戏已结束");
			}else{
				alert("操作失败");
	...
	$("#admin-setting-submit").click(function(){
		...
		$.post('ajax.dtsp.php', {"action" : 'admin', "admin_action" : 'edit_settings', "settings" : JSON.stringify(new_settings)}, function(data, status){
			if(data['success']){
				alert('修改成功');
			}else{
				alert('修改失败');
	...
	$("#admin-playerdata-submit").click(function(){
		...
		$.post('ajax.dtsp.php', {"action" : 'admin', "admin_action" : 'edit_playerdata', "data" : JSON.stringify(new_data)}, function(data, status){
			if(data['success']){
				alert('修改成功');
			}else{
				alert('修改失败');
	...
	$("#admin-playerdata-querysubmit").click(function(){
		...
		$.post('ajax.dtsp.php', {"action" : 'admin', "admin_action" : 'get_playerdata', "query" : query}, function(data, status){
			if(data['success']){
